...
<body>
    ...
    <?php
        $query = "SELECT * FROM productos WHERE idioma = 'english'";
        $resultado = $conexion->query($query);
    ?>
    <section class="productos">
        <h1>Productos en Ingles</h1>
        <p>Explora nuestra selección de productos en ingles. ¡Encuentra lo que buscas!</p>
